    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-3xl mx-auto px-6 py-10 space-y-8">
      ...
      <div className={sectionCls}>
        ...
        <p className={sectionDescCls}>
          ...
          <a href="mailto:membership@bali.org.uk" className="text-bali-leaf-ink underline">membership@bali.org.uk</a>{" "}
        ...
        {config.documents.map((d) => (
          <label key={d} className="flex items-start gap-3 mb-3">
            <input
              ...
              className="mt-1 h-5 w-5 rounded text-bali-leaf-ink focus:ring-bali-green"
            />
      ...
      <div className={sectionCls}>
        ...
        <p className={sectionDescCls}>
          Read our full{" "}
          <a href="https://bali.org.uk" target="_blank" rel="noopener noreferrer" className="text-bali-leaf-ink underline">terms & conditions</a>{" "}
