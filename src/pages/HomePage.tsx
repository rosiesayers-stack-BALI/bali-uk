...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* ── Testimonial ───────────────────────────────────────────── */}
      <section className="py-16 bg-white">
        <RevealDiv className="max-w-4xl mx-auto px-4 text-center">
          <svg className="w-10 h-10 text-bali-blue/20 mx-auto mb-4" fill="currentColor" viewBox="0 0 32 32">
          ...
          <blockquote className="text-xl text-gray-700 leading-relaxed italic mb-6">
            "Thank you so much for all your hard work and dedication to our garden project. You and the team have been amazing, working hard through all weathers."
          </blockquote>
          <p className="text-gray-500 font-medium">Danny — Private Client, Near Lewes, East Sussex</p>
          <p className="text-gray-400 text-sm">Via a BALI Accredited Member</p>
        </RevealDiv>
      </section>
