...
const C: Record<string, PageContent> = {
  ...
  "/about/conference": {
    ...
    highlights: [
      ...
      { title: "Practical breakouts", body: "Smaller, focused sessions where you choose the topics most relevant to your business and your role." },
      { title: "Exhibitor showcase", body: "Meet suppliers, partners and innovators across the day in the conference exhibition space." },
      { title: "Networking reception", body: "Close the day with peers, speakers and industry leaders over drinks — one of the best rooms in UK landscaping." },
    ],
    eventInfo: {
    ...
    sections: [
      {
        ...
        body: "Conference is built around a full day of headline keynotes, practical breakout sessions, an exhibitor showcase and a networking drinks reception. The format gives senior leaders and practitioners the space to step back from day-to-day delivery, hear from leading voices on the issues shaping landscaping, and leave with practical actions for their business.",
      },
      {
        heading: "Why attend",
        body: "",
        bullets: [
          "Hear from leading voices on the trends shaping landscaping — sustainability, biodiversity, plant health, skills, technology and economics",
          "Practical, take-home insight you can apply to your business straight away",
          "Connect with senior decision-makers from across the UK landscape industry",
          "Discover new products, services and partners in the exhibitor showcase",
  ...
  "/join": {
    ...
    theme: "green",
    intro: "Ready to apply? Choose your membership category, send us an enquiry, and our team will guide you through vetting, approval and activation.",
    ...
    sections: [
      {
        ...
        body: "Applying to BALI is a straightforward, supported process. Our membership team is on hand at every stage.",
        bullets: [
          "Choose the right membership category for your business or role",
          "Submit an enquiry — we'll confirm the documents and information required",
          "Vetting: an assessor reviews your application (and visits, where applicable)",
          "On approval, we issue an invoice for membership fees",
          "Once paid, your membership is activated and full benefits unlock",
        ],
      },
      {
        heading: "Choose your category",
        body: "BALI offers nine membership categories. Select the one that fits and review its specific requirements, fees and benefits before you apply. Not sure which is right for you? Our team can advise.",
        bullets: [
          "Accredited Contractor — hard/soft landscaping or grounds maintenance",
          "Accredited Designer — landscape and garden designers",
          "Accredited Supplier — materials and equipment suppliers",
          "Accredited Group — group structures of contractor businesses",
          "Accredited DSO — public sector / local authority grounds teams",
          "International — contractors operating outside the UK and Channel Islands",
          "Associate — businesses trading for less than two years",
          "Training Provider — trainers, colleges and universities",
          "Student — individuals on land-based training courses",
        ],
      },
      {
        heading: "What you'll need",
        body: "To speed up your application, please have the following ready before you enquire:",
        bullets: [
          "Confirmation that your business has been trading for at least two years (where required by category)",
          "Company registration and insurance details",
          "Examples of recent projects or client references (contractors and designers)",
          "A nominated lead contact for the application",
        ],
      },
      {
        heading: "Get in touch with the membership team",
        body: "Our membership team is here to help you choose the right category and complete your application. Email membership@bali.org.uk or call +44 (0)24 7669 0333 and we'll be in touch within 48 hours.",
      },
    ],
    ctaPrimary: { label: "Start your enquiry", href: "/membership/enquiry" },
    ctaSecondary: { label: "Explore member benefits", href: "/membership" },
  },
