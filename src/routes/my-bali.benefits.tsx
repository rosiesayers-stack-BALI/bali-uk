          ...
          return (
            <Card key={b.id} className="group transition-shadow hover:shadow-md">
              <div className="flex items-start gap-4">
                <span className="grid place-items-center w-11 h-11 rounded-lg bg-bali-leaf-ink/10 text-bali-leaf-ink shrink-0 group-hover:bg-bali-leaf-ink group-hover:text-white transition-colors">
