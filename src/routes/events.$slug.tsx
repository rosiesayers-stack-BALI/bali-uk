  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        ...(e?.image
          ? [
              { property: "og:image", content: e.image.url },
              { name: "twitter:image", content: e.image.url },
            ]
          : []),
      ],
    };
        ...
        >
          <div className="max-w-4xl mx-auto px-6 relative">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-blue-100">
              <span><strong className="text-white">Date:</strong> {event.date}</span>
        ...
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="mt-10 p-6 rounded-2xl bg-gradient-to-br from-bali-blue/5 to-bali-purple/5 border border-bali-blue/10">
            ...
            <p className="text-gray-700 text-sm mb-4">
              Bookings for this event are managed by the BALI team. Get in touch to reserve your place.
            </p>
            <Link
              to="/$"
              params={{ _splat: "contact-us" }}
              className="inline-block bg-bali-blue text-white px-6 py-3 rounded-lg font-semibold hover:bg-bali-purple transition-colors"
            >
              Contact the team →
            </Link>
          </div>
          ...
          <div className="mt-10 text-center">
            <Link to="/events" className="text-bali-blue font-semibold hover:underline">
              ← All events
            </Link>
          </div>
        </div>
