...
const TITLE = "Contractors — BALI Landscape Directory";
const DESC = "BALI Accredited contractors deliver hard landscaping, soft landscaping and grounds maintenance to professional, vetted standards across the UK.";

export const Route = createFileRoute("/directory/contractor")({
  head: () => ({
    meta: [
      { title: TITLE },
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <main className="flex-1">
        ...
        <DirectoryListing initialCategory="contractor" lockCategory />
      </main>
      <Footer />
      <CookieBanner />
    </div>
