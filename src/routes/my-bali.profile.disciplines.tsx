    ...
    <Card>
      ...
      <form onSubmit={submit}>
        ...
        <div className="flex justify-end">
          <button disabled={!canEdit} className="bg-bali-blue hover:bg-blue-800 text-white font-semibold px-6 py-2.5 rounded-lg text-sm disabled:bg-gray-300 disabled:cursor-not-allowed">Save disciplines</button>
        </div>
        </fieldset>
      </form>
    </Card>
